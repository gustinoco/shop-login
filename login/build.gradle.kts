...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "DEV_CHARON", "\"replace_charonId\"")
        buildConfigField("String", "HOMOL_CHARON", "\"replace_charonId\"")
        buildConfigField("String", "PROD_CHARON", "\"replace_charonId\"")
    }
